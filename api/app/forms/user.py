...
class UserRegistrationForm(Form):
    ...
    confirmPassword = PasswordField('confirm_password',
     [validators.DataRequired(
        "Confirmation "
        "password is required!"), validators.EqualTo('password', message='Passwords must match')])
...
class UserUpdatePasswordForm(Form):
    ...
    password = PasswordField('password', [validators.DataRequired("Password is required!"),
                                               validators.EqualTo('confirm_password',
                                                                  "Password don't match!")])
    confirm_password = PasswordField('confirm_password', [validators.EqualTo('password', message='Passwords must match')])
